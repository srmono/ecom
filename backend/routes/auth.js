...
// //Login Route
// router.post('/login', 
//     [helpers.hasAuthFields, helpers.isPasswordAndUserMatch],
//     (req, res) => {
//         let token = jwt.sign({state: 'true', email: req.body.email, username: req.body.username}, helpers.secret, {
//             algorithm: 'HS512',
//             expiresIn: '4h'
//         });
//         res.json({token: totken, auth: true, email: req.body.email, username: req.body.username})
// })
...
//         .isLength({min: 6}).withMessage("Pw must be 6 characters long"),
//     body('email').custom( value => {
//         return helpers.database.table('users').filter({
//             $or: [
...
//          * ROLE 555 = CUSTOMER
//          */
//         helpers.database.table('users').insert({
//             username: username,
//             password: password,
//             email: email,
//             role: 555,
